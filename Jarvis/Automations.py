...
def WhatsApp():
    ...
    startfile("C:\\Users\\koush\\AppData\\Local\\WhatsApp\\WhatsApp.exe")
...
def AmazonPrime():
    web.open("https://www.primevideo.com/?ref_=av_auth_return_redir")
...
def Notepad():
    ...
    path_1 = "D:\\How To Make Jarvis\\" + str(filename)

    path_2 = "D:\\How To Make Jarvis\\DataBase\\NotePad\\" + str(filename)
